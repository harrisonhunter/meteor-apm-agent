Tinytest.add('Errors - enableErrorTracking', function (test) {
...
Tinytest.add('Errors - disableErrorTracking', function (test) {
  var originalErrorTrackingStatus = Kadira.options.enableErrorTracking;
...
Tinytest.add('Errors - Custom Errors - simple', function (test) {
...
Tinytest.add('Errors - Custom Errors - with all values', function (test) {
  var originalTrackError = Kadira.models.error.trackError;
  var originalErrorTrackingStatus = Kadira.options.enableErrorTracking;
  Kadira.enableErrorTracking();
  Kadira.models.error.trackError = function (err, trace) {
