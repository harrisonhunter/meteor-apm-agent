Tinytest.add('CPU Profiler - set labels - Session.prototype.send', function (
  test
) {
  test.equal(MeteorX.Session.prototype.send.name, 'kadira_Session_send');
});

Tinytest.add('CPU Profiler - set labels - MongoCursor methods', function (
  test
) {
...
Tinytest.add('CPU Profiler - set labels - MongoConnection methods', function (
  test
) {
...
Tinytest.add('CPU Profiler - set labels - Session sends', function (test) {
...
Tinytest.add('CPU Profiler - set labels - Crossbar methods', function (test) {
