Tinytest.add('Database - insert', function (test) {
...
Tinytest.add('Database - insert with async callback', function (test) {
  EnableTrackingMethods();
  var methodId = RegisterMethod(function () {
...
Tinytest.add('Database - throw error and catch', function (test) {
  EnableTrackingMethods();
  var methodId = RegisterMethod(function () {
    try {
  ...
  if (events && events[3] && events[3][2] && events[3][2].err) {
    events[3][2].err =
      events[3][2].err.indexOf('E11000') >= 0 ? 'E11000' : null;
  }
  var expected = [
    ['start', , { userId: null, params: '[]' }],
    ['wait', , { waitOn: [] }],
...
Tinytest.add('Database - update', function (test) {
  EnableTrackingMethods();
...
Tinytest.add('Database - remove', function (test) {
  EnableTrackingMethods();
  TestData.insert({ _id: 'aa', dd: 10 });
  var methodId = RegisterMethod(function () {
...
Tinytest.add('Database - findOne', function (test) {
  EnableTrackingMethods();
  TestData.insert({ _id: 'aa', dd: 10 });
  var methodId = RegisterMethod(function () {
...
Tinytest.add('Database - findOne with sort and fields', function (test) {
  EnableTrackingMethods();
  TestData.insert({ _id: 'aa', dd: 10 });
  var methodId = RegisterMethod(function () {
...
Tinytest.add('Database - upsert', function (test) {
  EnableTrackingMethods();
  var methodId = RegisterMethod(function () {
...
Tinytest.add('Database - upsert with update', function (test) {
  EnableTrackingMethods();
  var methodId = RegisterMethod(function () {
...
Tinytest.add('Database - indexes', function (test) {
  EnableTrackingMethods();
  var methodId = RegisterMethod(function () {
  ...
  var expected = [
    ...
    [
      ...
      ,
      {
        coll: 'tinytest-data',
        func: '_ensureIndex',
        index: JSON.stringify({ aa: 1, bb: 1 }),
      },
    ],
    [
      'db',
...
Tinytest.add('Database - Cursor - count', function (test) {
  EnableTrackingMethods();
  ...
  var expected = [
    ...
    [
      'db',
      ,
      { coll: 'tinytest-data', func: 'find', selector: JSON.stringify({}) },
    ],
    [
      'db',
      ,
...
Tinytest.add('Database - Cursor - fetch', function (test) {
  EnableTrackingMethods();
  TestData.insert({ _id: 'aa' });
  ...
  var expected = [
    ...
    [
      ...
      ,
      {
        coll: 'tinytest-data',
        func: 'find',
        selector: JSON.stringify({ _id: { $exists: true } }),
      },
    ],
    [
      'db',
      ,
      {
        ...
        selector: JSON.stringify({ _id: { $exists: true } }),
        docsFetched: 2,
        docSize: JSON.stringify({ _id: 'aa' }).length * 2,
      },
    ],
    ['complete'],
  ];
...
Tinytest.add('Database - Cursor - map', function (test) {
  EnableTrackingMethods();
  TestData.insert({ _id: 'aa' });
  TestData.insert({ _id: 'bb' });
  var methodId = RegisterMethod(function () {
...
Tinytest.add('Database - Cursor - forEach', function (test) {
  EnableTrackingMethods();
  TestData.insert({ _id: 'aa' });
  TestData.insert({ _id: 'bb' });
  var methodId = RegisterMethod(function () {
...
Tinytest.add('Database - Cursor - forEach:findOne inside', function (test) {
  EnableTrackingMethods();
  TestData.insert({ _id: 'aa' });
  TestData.insert({ _id: 'bb' });
  var methodId = RegisterMethod(function () {
...
Tinytest.add('Database - Cursor - observeChanges', function (test) {
  EnableTrackingMethods();
  TestData.insert({ _id: 'aa' });
  TestData.insert({ _id: 'bb' });
  var methodId = RegisterMethod(function () {
...
Tinytest.add('Database - Cursor - observe', function (test) {
  EnableTrackingMethods();
  TestData.insert({ _id: 'aa' });
  TestData.insert({ _id: 'bb' });
  var methodId = RegisterMethod(function () {
...
Tinytest.add('Database - Cursor - rewind', function (test) {
  EnableTrackingMethods();
  TestData.insert({ _id: 'aa' });
  TestData.insert({ _id: 'bb' });
  var methodId = RegisterMethod(function () {
