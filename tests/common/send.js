Tinytest.add('Kadira Send - Kadira._getSendFunction', function (test) {
...
Tinytest.addAsync('Kadira Send - send data', function (test, done) {
...
Tinytest.addAsync('Kadira Send - Kadira.send with path', function (test, done) {
  var payload = { aa: 10 };
