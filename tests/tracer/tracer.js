Tinytest.add('Tracer - Trace Method - method', function (test) {
  var ddpMessage = {
    id: 'the-id',
    msg: 'method',
    method: 'method-name',
  };
  var traceInfo = Kadira.tracer.start(
    { id: 'session-id', userId: 'uid' },
    ddpMessage
  );
...
Tinytest.add('Tracer - Trace Method - complete after errored', function (test) {
  var ddpMessage = {
    id: 'the-id',
    msg: 'method',
    method: 'method-name',
  ...
  var expected = {
    ...
    type: 'method',
    name: 'method-name',
    events: [{ type: 'start' }, { type: 'error' }],
  };
  test.equal(traceInfo, expected);
});

Tinytest.add('Tracer - trace sub', function (test) {
  var ddpMessage = {
    id: 'the-id',
    msg: 'sub',
    name: 'sub-name',
...
Tinytest.add('Tracer - trace other ddp', function (test) {
  var ddpMessage = {
    id: 'the-id',
    msg: 'unsub',
    name: 'sub-name',
...
Tinytest.add('Tracer - trace other events', function (test) {
  var ddpMessage = {
    id: 'the-id',
    msg: 'method',
    method: 'method-name',
...
Tinytest.add('Tracer - invalid eventId', function (test) {
  var ddpMessage = {
    id: 'the-id',
    msg: 'method',
    method: 'method-name',
...
Tinytest.add('Tracer - end last event', function (test) {
  var ddpMessage = {
    id: 'the-id',
    msg: 'method',
    method: 'method-name',
...
Tinytest.add('Tracer - trace same event twice', function (test) {
  var ddpMessage = {
    id: 'the-id',
    msg: 'method',
    method: 'method-name',
...
Tinytest.add('Tracer - Build Trace - simple', function (test) {
...
Tinytest.add('Tracer - Build Trace - errored', function (test) {
  var now = new Date().getTime();
  var traceInfo = {
    events: [
      { type: 'start', at: now },
...
Tinytest.add('Tracer - Build Trace - no start', function (test) {
  var now = new Date().getTime();
  var traceInfo = {
    events: [
      { type: 'wait', at: now },
...
Tinytest.add('Tracer - Build Trace - no complete', function (test) {
  var now = new Date().getTime();
  var traceInfo = {
    events: [
      { type: 'start', at: now },
...
Tinytest.add('Tracer - Build Trace - event not ended', function (test) {
  var now = new Date().getTime();
  var traceInfo = {
    events: [
      { type: 'start', at: now },
...
Tinytest.add('Tracer - Filters - filter start', function (test) {
...
Tinytest.add('Tracer - Filters - filter end', function (test) {
  var tracer = new Tracer();
  tracer.addFilter(function (type, data) {
...
Tinytest.add('Tracer - Filters - ignore side effects', function (test) {
  var tracer = new Tracer();
  tracer.addFilter(function (type, data) {
...
Tinytest.add('Tracer - Filters - multiple filters', function (test) {
  var tracer = new Tracer();
  tracer.addFilter(function (type, data) {
    return _.pick(data, 'coll');
  });
...
Tinytest.add('Tracer - Filters - Filter by method name', function (test) {
  var tracer = new Tracer();
...
Tinytest.add('Tracer - Filters - Filter by sub name', function (test) {
  var tracer = new Tracer();
  tracer.addFilter(function (type, data, info) {
